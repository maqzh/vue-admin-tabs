        ...
        let meta = {
            ...
            component: (resolve) => {
                require.ensure([], (require) => {
                    try{
                        resolve(require.context('@', true, /\.vue$/)(`${component}`))
                    }catch(error){
                        if(_this.vm.$layer){
                            _this.vm.$layer.msg(_this.vm.$t('tabbar.component.noexit', {'component':tab.component}))
                        }
                         _this.vm.close(tab)
                    }
                }, 'tab_component_require')
            }
        }
        return meta
    }
